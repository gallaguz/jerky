...
import { CatalogIngredientModule } from './catalog-ingredient-module';

type TModel = TIngredientWithPayload;
type TModelWithPayload = TIngredientWithPayload;
class CreateRequest extends InternalIngredientCreateCommandContract.Request {}
type CreateResponse = InternalIngredientCreateCommandContract.Response;
const CreateTopic = InternalIngredientCreateCommandContract.topic;

class UpdateRequest extends InternalIngredientUpdateCommandContract.Request {}
type UpdateResponse = InternalIngredientUpdateCommandContract.Response;
const UpdateTopic = InternalIngredientUpdateCommandContract.topic;

class RemoveRequest extends InternalIngredientRemoveCommandContract.Request {}
type RemoveResponse = InternalIngredientRemoveCommandContract.Response;
const RemoveTopic = InternalIngredientRemoveCommandContract.topic;

class FindOneRequest extends InternalIngredientFindOneQueryContract.Request {}
type FindOneResponse = InternalIngredientFindOneQueryContract.Response;
const FindOneTopic = InternalIngredientFindOneQueryContract.topic;

class FindManyRequest extends InternalIngredientFindManyQueryContract.Request {}
type FindManyResponse = InternalIngredientFindManyQueryContract.Response;
const FindManyTopic = InternalIngredientFindManyQueryContract.topic;

describe('[ Ingredient Controller ]', () => {
    let app: NestApplication;
    let controller: CatalogIngredientController;
    ...
    beforeAll(async () => {
        ...
        controller = app.get<CatalogIngredientController>(
            CatalogIngredientController,
        );
    ...
    const generateBaseProps = (): CreateRequest => {
        return {
            data: {
                ...
                price: Random.pickNumberInRange(1, 100),
                payload: Random.pickNumberInRange(1, 100),
            },
        };
    };
