...
import { CatalogRawTypeModule } from './catalog-raw-type-module';

type TModel = TRawTypeWithPayload;
type TModelWithPayload = TRawTypeWithPayload;
class CreateRequest extends InternalRawTypeCreateCommandContract.Request {}
type CreateResponse = InternalRawTypeCreateCommandContract.Response;
const CreateTopic = InternalRawTypeCreateCommandContract.topic;

class UpdateRequest extends InternalRawTypeUpdateCommandContract.Request {}
type UpdateResponse = InternalRawTypeUpdateCommandContract.Response;
const UpdateTopic = InternalRawTypeUpdateCommandContract.topic;

class RemoveRequest extends InternalRawTypeRemoveCommandContract.Request {}
type RemoveResponse = InternalRawTypeRemoveCommandContract.Response;
const RemoveTopic = InternalRawTypeRemoveCommandContract.topic;

class FindOneRequest extends InternalRawTypeFindOneQueryContract.Request {}
type FindOneResponse = InternalRawTypeFindOneQueryContract.Response;
const FindOneTopic = InternalRawTypeFindOneQueryContract.topic;

class FindManyRequest extends InternalRawTypeFindManyQueryContract.Request {}
type FindManyResponse = InternalRawTypeFindManyQueryContract.Response;
const FindManyTopic = InternalRawTypeFindManyQueryContract.topic;

describe('[ RawType Controller ]', () => {
    let app: NestApplication;
    let controller: CatalogRawTypeController;
    ...
    beforeAll(async () => {
        ...
        controller = app.get<CatalogRawTypeController>(
            CatalogRawTypeController,
        );
