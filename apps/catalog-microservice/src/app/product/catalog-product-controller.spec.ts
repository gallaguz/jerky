...
import { CatalogProductModule } from './catalog-product-module';

type TModel = TProductWithPayload;
type TModelWithPayload = TProductWithPayload;
class CreateRequest extends InternalProductCreateCommandContract.Request {}
type CreateResponse = InternalProductCreateCommandContract.Response;
const CreateTopic = InternalProductCreateCommandContract.topic;

class UpdateRequest extends InternalProductUpdateCommandContract.Request {}
type UpdateResponse = InternalProductUpdateCommandContract.Response;
const UpdateTopic = InternalProductUpdateCommandContract.topic;

class RemoveRequest extends InternalProductRemoveCommandContract.Request {}
type RemoveResponse = InternalProductRemoveCommandContract.Response;
const RemoveTopic = InternalProductRemoveCommandContract.topic;

class FindOneRequest extends InternalProductFindOneQueryContract.Request {}
type FindOneResponse = InternalProductFindOneQueryContract.Response;
const FindOneTopic = InternalProductFindOneQueryContract.topic;

class FindManyRequest extends InternalProductFindManyQueryContract.Request {}
type FindManyResponse = InternalProductFindManyQueryContract.Response;
const FindManyTopic = InternalProductFindManyQueryContract.topic;
...
describe('[ Product Controller ]', () => {
    ...
    beforeAll(async () => {
        ...
        controller = app.get<CatalogProductController>(
