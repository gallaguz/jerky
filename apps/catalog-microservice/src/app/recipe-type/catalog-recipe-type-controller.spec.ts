...
import { CatalogRecipeTypeModule } from './catalog-recipe-type-module';

type TModel = TCategoryWithPayload;
type TModelWithPayload = TRecipeTypeWithPayload;
class CreateRequest extends InternalRecipeTypeCreateCommandContract.Request {}
type CreateResponse = InternalRecipeTypeCreateCommandContract.Response;
const CreateTopic = InternalRecipeTypeCreateCommandContract.topic;

class UpdateRequest extends InternalRecipeTypeUpdateCommandContract.Request {}
type UpdateResponse = InternalRecipeTypeUpdateCommandContract.Response;
const UpdateTopic = InternalRecipeTypeUpdateCommandContract.topic;

class RemoveRequest extends InternalRecipeTypeRemoveCommandContract.Request {}
type RemoveResponse = InternalRecipeTypeRemoveCommandContract.Response;
const RemoveTopic = InternalRecipeTypeRemoveCommandContract.topic;

class FindOneRequest extends InternalRecipeTypeFindOneQueryContract.Request {}
type FindOneResponse = InternalRecipeTypeFindOneQueryContract.Response;
const FindOneTopic = InternalRecipeTypeFindOneQueryContract.topic;

class FindManyRequest extends InternalRecipeTypeFindManyQueryContract.Request {}
type FindManyResponse = InternalRecipeTypeFindManyQueryContract.Response;
const FindManyTopic = InternalRecipeTypeFindManyQueryContract.topic;

describe('[ RecipeType Controller ]', () => {
    let app: NestApplication;
    let controller: CatalogRecipeTypeController;
    ...
    beforeAll(async () => {
        ...
        controller = app.get<CatalogRecipeTypeController>(
            CatalogRecipeTypeController,
        );
