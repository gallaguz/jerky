...
import { CatalogRawModule } from './catalog-raw-module';

type TModel = TRawWithPayload;
type TModelWithPayload = TRawWithPayload;
class CreateRequest extends InternalRawCreateCommandContract.Request {}
type CreateResponse = InternalRawCreateCommandContract.Response;
const CreateTopic = InternalRawCreateCommandContract.topic;

class UpdateRequest extends InternalRawUpdateCommandContract.Request {}
type UpdateResponse = InternalRawUpdateCommandContract.Response;
const UpdateTopic = InternalRawUpdateCommandContract.topic;

class RemoveRequest extends InternalRawRemoveCommandContract.Request {}
type RemoveResponse = InternalRawRemoveCommandContract.Response;
const RemoveTopic = InternalRawRemoveCommandContract.topic;

class FindOneRequest extends InternalRawFindOneQueryContract.Request {}
type FindOneResponse = InternalRawFindOneQueryContract.Response;
const FindOneTopic = InternalRawFindOneQueryContract.topic;

class FindManyRequest extends InternalRawFindManyQueryContract.Request {}
type FindManyResponse = InternalRawFindManyQueryContract.Response;
const FindManyTopic = InternalRawFindManyQueryContract.topic;

describe('[ Raw Controller ]', () => {
    let app: NestApplication;
    let controller: CatalogRawController;
    ...
    beforeAll(async () => {
        ...
        controller = app.get<CatalogRawController>(CatalogRawController);
