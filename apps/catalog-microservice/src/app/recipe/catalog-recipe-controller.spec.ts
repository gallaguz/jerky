...
import { CatalogRecipeModule } from './catalog-recipe-module';

type TModel = TRecipeWithPayload;
type TModelWithPayload = TRecipeWithPayload;
class CreateRequest extends InternalRecipeCreateCommandContract.Request {}
type CreateResponse = InternalRecipeCreateCommandContract.Response;
const CreateTopic = InternalRecipeCreateCommandContract.topic;

class UpdateRequest extends InternalRecipeUpdateCommandContract.Request {}
type UpdateResponse = InternalRecipeUpdateCommandContract.Response;
const UpdateTopic = InternalRecipeUpdateCommandContract.topic;

class RemoveRequest extends InternalRecipeRemoveCommandContract.Request {}
type RemoveResponse = InternalRecipeRemoveCommandContract.Response;
const RemoveTopic = InternalRecipeRemoveCommandContract.topic;

class FindOneRequest extends InternalRecipeFindOneQueryContract.Request {}
type FindOneResponse = InternalRecipeFindOneQueryContract.Response;
const FindOneTopic = InternalRecipeFindOneQueryContract.topic;

class FindManyRequest extends InternalRecipeFindManyQueryContract.Request {}
type FindManyResponse = InternalRecipeFindManyQueryContract.Response;
const FindManyTopic = InternalRecipeFindManyQueryContract.topic;

describe('[ Recipe Controller ]', () => {
    let app: NestApplication;
    let controller: CatalogRecipeController;
    ...
    beforeAll(async () => {
        ...
        controller = app.get<CatalogRecipeController>(CatalogRecipeController);
