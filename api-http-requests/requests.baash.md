...
``` bash
curl --request GET \
  --url http://localhost:3000/api/review/byProduct/6349811483c52343ee4d9151 \
  --header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImVtYWlsQGVtYWlsLmNvbSIsImlhdCI6MTY2NTc2OTE2MH0.MUCXSOSkTtRh-tRdruKNdZdvhd6T-K6g0PRl9PmzHqM'
```
...
``` bash
curl --request GET \
  --url http://localhost:3000/api/page/byAlias/hosting
```

## CreatePage
``` bash
curl --request POST \
  --url http://localhost:3000/api/page/create \
...
``` bash
curl --request PATCH \
  --url http://localhost:3000/api/page/63499f75fca654e6dd1ff636 \
  --header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImVtYWlsQGVtYWlsLmNvbSIsImlhdCI6MTY2NTc2OTE2MH0.MUCXSOSkTtRh-tRdruKNdZdvhd6T-K6g0PRl9PmzHqM' \
  --header 'Content-Type: application/json' \
  --data '{
  "tags": [
...
``` bash
curl --request GET \
  --url https://localhost:3000/api/page/textSearch/photoshop \
  --header 'Content-Type: application/json'
```
...
``` bash
curl --request DELETE \
  --url http://localhost:3000/api/page/63499e51fca654e6dd1ff62d
```

## FindPage
``` bash
curl --request POST \
  --url http://localhost:3000/api/page/find \
  --header 'Content-Type: application/json' \
  --data '{
	"firstCategory": 2
}'
...
curl --request POST \
  ...
  --header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImVtYWlsQGVtYWlsLmNvbSIsImlhdCI6MTY2NTg3MzA5Mn0._hYdB8QF1ZRqo8Poc822-lDINdtJK1iN6mwcgNHjfPI' \
  --header 'Content-Type: multipart/form-data; boundary=---011000010111000001101001' \
  --form files=@/home/gallaguz/Pictures/img.png
```
